...
function fixture() {
  ...
  const row: CreativeBriefRow = {
    ...
    runtimeTarget: created.value.runtimeTarget,
    deliveryPlatform: created.value.deliveryPlatform,
    references: created.value.references,
    restrictions: created.value.restrictions,
    clientRequirements: created.value.clientRequirements,
    nonNegotiables: created.value.nonNegotiables,
    successCriteria: created.value.successCriteria,
